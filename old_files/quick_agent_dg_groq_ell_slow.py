...
class LanguageModelProcessor:
    def __init__(self):
        self.llm = ChatGroq(temperature=0, model_name="llama3-70b-8192", groq_api_key=os.getenv("GROQ_API_KEY")) # mixtral-8x7b-32768, llama3-70b-8192, llama2-70b-4096
...
class TextToSpeechElevenLabs:
    ...
    MODEL_NAME = "eleven_multilingual_v2"  # Example model name, change as needed
